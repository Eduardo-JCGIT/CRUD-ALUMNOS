...
export const EditAlumn = () => {
    ...
    //Esto queda pendeinte
    //guardar Cambios

    useEffect(() =>{
        const getAlumnById = async () =>{
            const response = await axios.get(`${endponit}${id}`)
...
<h1 className="display-4">Editar Alumno</h1>
<p className="lead">ingresa los datos nuevos del alumno</p>
    </div>
    </div>
    </div>
